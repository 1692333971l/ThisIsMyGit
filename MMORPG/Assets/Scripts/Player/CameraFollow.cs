...
{
    private bool _viewpointMovement = true;//是否允许视角移动
    ...
    public void SetViewpointMovement(bool viewpointMovement)
    {
        _viewpointMovement = viewpointMovement;
    }
